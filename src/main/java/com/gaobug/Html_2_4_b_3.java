...
//        }
        ...
        String title=hotkey+" "+productname;
        String h1name=hotkey+" "+productname;
...
//                }
        ...
        String meta_description=metades+","+productname+","+cate3+subproductnam+"-"+serverName;
...
//                mainimage, price, hostName + "/?" + url+shellflag, hostName, (String) listJson.get(0),cate2url,cate3url,"",cate1,cate2,cate3,"json7");
//        //产品
//        String json1 = Getsitemapurl.productJson(productname, des,
//                mainimage, price, hostName + "/?" + url+shellflag, hostName, (String) listJson.get(0),cate2url,cate3url,"",cate1,cate2,cate3,"json8");
