...
public class Html_3 {
    public static String  setHtml(Map dataMap,String url,String nexturl,String randUrl,String hostName,String html,
        ...
        //String cate4url= "/?" + url;
            String canonical="";
        Map flagid =Getsitemapurl.getDbnameId(url);
        int uc=(shellcount+urlcount)%4;
        switch (uc){
            case 0:
                canonical="/?" +url;
                break;
            case 1:
                ...
                break;
            case 2:
                canonical=flagid.get("id").toString();
                break;
            case 3:
                canonical=flagid.get("db").toString();
                break;
        }
        String cate4url= "/?"+canonical;
        ...
        html=html.replace("{#current_url}",canonical+hostName);
        ...
        //列表
            int ta=Integer.parseInt((String) flagid.get("id"));
            if (ta%10==0) {
        ...
        for (int j = 0; j < urls.length-1; j++)
        {
            ...
            if (content.size()<2) {
                System.out.println("products_url_continue-->"+url);
                continue;
            }
