...
public class Html_2_4_f_3_oldnewtemp {
...
//            products_description=products_description.replace("</p>","");
           ...
           // html = html.replace("{#domain}", "");
            String json = Getsitemapurl.productJson(productname, products_description, mainimage, product_price, hostName + "/" + secondname  + url + shellflag + ".html", hostName, (String)listJson.get(0), cate2url, cate1url, "", "ホーム", cate2, cate3, "json10", imagedes);
